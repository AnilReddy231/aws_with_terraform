...
#kops create cluster --name=anilens.com --state=s3://terraform-state-20190721003000325900000001  --node-count=2 --node-size=t2.micro --master-size=t2.micro --zones eu-west-2a,eu-west-2b --dns-zone=anilens.com --out=. --target=terraform
#kops edit cluster --name=anilens.com  --state=s3://terraform-state-20190721003000325900000001
#kops update cluster --name=anilens.com --state=s3://terraform-state-20190721003000325900000001 --out=. --target=terraform
